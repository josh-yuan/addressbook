...
public class AddressBookDAO extends AbstractDAO<Student> {
	...
	public List<Student> findByName(String name) {
		...
		return list(namedQuery("com.addressbook.api.application.pojo.Student.findByName").setParameter("name",
				builder.toString()));
	}
	...
	public List<Student> findByParent(String parent) {
		...
		return list(namedQuery("com.addressbook.api.application.pojo.Student.findByParent").setParameter("parent",
				builder.toString()));
	}

	public List<Student> findByGrade(int grade) {
		return list(
				namedQuery("com.addressbook.api.application.pojo.Student.findByGrade").setParameter("grade", grade));
	}
}
